...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/admin/legal-documents", h.legalDocumentsPage)
	mux.HandleFunc("/admin/legal-documents/toggle", h.toggleLegalDocument)
	mux.HandleFunc("/admin/legal-documents/delete", h.deleteLegalDocument)
	mux.HandleFunc("/admin/legal-documents/export.csv", h.exportLegalDocumentsCSV)
