...
Примечание: CSV-экспорт уже реализован для `connectors`, `users`, `events`, `billing/payments`, `billing/subscriptions`, `churn`; остаются экран оферт и дальнейшие операционные срезы.
